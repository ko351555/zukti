    ...
    render() {
        ...
        return (
            ...
            <Modal size='small' open={open} Icon='close' onClose={this.close}   onMount={this.fetchValuesFromDatabase}
                         closeOnRootNodeClick={false} size="tiny" label='close' closeIcon='close' id='modallogincss' >
                       <Modal.Header>
                         ...
                         <Grid>
                           <Grid.Column width={4}>
                             ...
                             <Menu fluid vertical tabular pointing secondary  >
                               <Menu.Item name='Statistics' text='123' type='234\' active={activeItem === 'Stat'} onClick={this.handleItemClick}/>
